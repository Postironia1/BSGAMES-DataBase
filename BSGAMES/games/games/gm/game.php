				...
				<div class="maininfo">
					...
					<div class="block" id="rating">
						...
						<div class="content">
							...
							<div class="reviews">
								<div class="review" >
										<p class="fill">&quot;It brings back the silly glee of unbridled experimentation, intuitive learning and playful social interactions that most of us haven't experienced since childhood. For that, it's essential.&quot;</p>
									<a href=""><div class="subfill"><p class="name">PC Gamer</p></div></a>
								</div>
								<!-- <div class="review" >
										<p class="fill">&quot;Фaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф&quot;</p>
									<a href=""><div class="subfill"><p class="name">Erick</p></div></a>
								</div>
								<div class="review" >
										<p class="fill">&quot;Фaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф aaaффффф&quot;</p>	
									<a href=""><div class="subfill"><p class="name">Erick</p></div></a>
					...
					<div class="block" id="specification">
						...
						<div class="content">
							<div class="spec" id="opt">
								...
								<div class="param">
									<p class="label">ОС</p>
									<p class="value">Windows® 7/8/8.1/10</p>
								</div>
								<div class="param">
									<p class="label">Процессор</p>
									<p class="value">2.5 GHz Processor или лучше/p>
								</div>
								<div class="param">
									<p class="label">Видеокарта</p>
									<p class="value">1GB dedicated VRAM или лучше</p>
								</div>
								<div class="param">
								...
								<div class="param">
									...
									<p class="value">20 ГБ</p>
								</div>
								<div class="param" id = "last">
									<p class="label">DirectX</p>
									<p class="value">DirectX 9.0c</p>
								</div>
							...
							<div class="spec" id="min">
								...
								<div class="param">
									<p class="label">ОС</p>
									<p class="value">Windows® XP/Vista</p>
								</div>
								<div class="param">
									<p class="label">Процессор</p>
									<p class="value">2 GHz Processor или лучше</p>
								</div>
								<div class="param">
									<p class="label">Видеокарта</p>
									<p class="value">512MB dedicated VRAM или лучше</p>
								</div>
								<div class="param">
									<p class="label">Память</p>
								...
								<div class="param">
									<p class="label">Место на диске</p>
									<p class="value">5 ГБ</p>
								</div>
								<div class="param" id = "last">
									<p class="label">DirectX</p>
									<p class="value">DirectX 9</p>
								</div>
				...
				<aside class="subinfo">
					...
					<div class="info">
						<div class="line">
							...
							<h2 class="value">Facepunch Studios</h2>	
							
						</div>
						<div class="line">
							<h2 class="label">Издатель</h2>
							<h2 class="value">Valve</h2>
						</div>
						<div class="line">
							<h2 class="label">Дата выхода	</h2>
							<h2 class="value">29.10.06</h2>
						</div>
						<div class="line">
