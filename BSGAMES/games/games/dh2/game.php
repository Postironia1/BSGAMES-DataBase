		...
		<section class="game">
			...
			<div class="gameinfo">
				<div class="maininfo">
					...
					<div class="info">
						<p>
							В игре Dishonored 2, вы снова окажетесь в роли ассасина со сверхъестественными способностями. Сайт IGN назвал эту игру «удивительной» и «идеальным продолжением», Eurogamer признал ее «шедевром», а Game Informer считает, что «эта история о мести – одна
						</p>
					</div>
					...
					<div class="block" id="rating">
						...
						<div class="content">
							...
							<div class="reviews">
								<div class="review" >
										<p class="fill">&quot;Amazing&quot;</p>
									<a href=""><div class="subfill"><p class="name">IGN</p></div></a>
								</div>
								<div class="review" >
										<p class="fill">&quot;It's Brilliant&quot;</p>
									<a href=""><div class="subfill"><p class="name">PC Gamer</p></div></a>
								</div>
								<div class="review" >
										<p class="fill">&quot;A Must-Play Revenge Tale&quot;</p>	
					...
					<div class="block" id="specification">
						...
						<div class="content">
							<div class="spec" id="opt">
								...
								<div class="param">
									<p class="label">ОС</p>
									<p class="value">Windows 10 (64-битная)</p>
								</div>
								<div class="param">
									<p class="label">Процессор</p>
									<p class="value">Intel Core i7-4770/AMD FX-8350 или лучше</p>
								</div>
								<div class="param">
									<p class="label">Видеокарта</p>
									<p class="value">NVIDIA GTX 1060 6 ГБ/AMD Radeon RX 480 8 ГБ или лучше</p>
								</div>
								<div class="param">
									<p class="label">Память</p>
									<p class="value">16 ГБ</p>
								</div>
								<div class="param" id = "last">
									<p class="label">Место на диске</p>
									<p class="value">60 ГБ</p>
								</div>
							...
							<div class="spec" id="min">
								...
								<div class="param">
									<p class="label">ОС</p>
									<p class="value">Windows 7/8/10 (64-битные)</p>
								</div>
								<div class="param">
									<p class="label">Процессор</p>
									<p class="value">Intel Core i5-2400/AMD FX-8320 или лучше</p>
								</div>
								<div class="param">
									<p class="label">Видеокарта</p>
									<p class="value">NVIDIA GTX 660 2 ГБ/AMD Radeon HD 7970 3 ГБ или лучше</p>
								</div>
								<div class="param">
									<p class="label">Память</p>
				...
				<aside class="subinfo">
					...
					<div class="info">
						<div class="line">
							...
							<h2 class="value">Arkane Studios</h2>	
							
						</div>
						<div class="line">
							<h2 class="label">Издатель</h2>
							<h2 class="value">Bethesda Softworks</h2>
						</div>
						<div class="line">
							<h2 class="label">Дата выхода	</h2>
							<h2 class="value">11.10.16</h2>
						</div>
						<div class="line">
